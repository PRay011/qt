...
void Enroll::EnrollTrue()
{
    ...
    QString S=QString("insert into User (Name,Password,姓名,住址,联系方式)values('%1','%2','%3','%4','%5');").arg(Name).arg(Password).arg("空").arg("空").arg("空");
    //传给服务器
...
void Enroll::on_Enrollnew_clicked()
{
    ...
    {
        QString S1=QString("select * from User where Name ='%1'").arg(Name);
        //传给服务器
